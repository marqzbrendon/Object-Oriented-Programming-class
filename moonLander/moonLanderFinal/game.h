...
public:
   ...
   Game(Point tl, Point br) : topLeft(tl), bottomRight(br), ground(Ground(topLeft, bottomRight))
   {
      ...
      lander.setFuel(FUEL);
	  lander.setPoint(Point(0, tl.getY() - 25));
	  landerLocation.setX(random(-190, -60));
	  landerLocation.setY(random(100, 180));
	  landerLocation2.setX(random(-50, 80));
	  landerLocation2.setY(random(100, 180));
	  landerLocation3.setX(random(90, 190));
	  landerLocation3.setY(random(100, 180));
   }
...
private:
   ...
   Ground ground;
   Lander lander;
   Point landerLocation;
   Point landerLocation2;
   Point landerLocation3;
